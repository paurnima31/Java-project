...
AllCreditCust()
        {
             try
             {
                 ...
                 pst=cn.prepareStatement("select * from sale where remamt>0");  
                 rs=pst.executeQuery();
                 rsm=rs.getMetaData();
                 int col=rsm.getColumnCount();
                  
                 bw=new BufferedWriter(new FileWriter("allcreditcust.html"));
                 bw.write("<h1 align=center><font color=Red face=Comic Sans MS>GURUKRUPA GROCESARY SHOP</font></h1>");
                 bw.write("<br>"); 
                 bw.write("<h2 align=center><font color=blue>All Credit Customer Report</h2>"); 
                 ...
                 r.exec(" explorer allcreditcust.html");  
              }
              catch(Exception e)
             {
